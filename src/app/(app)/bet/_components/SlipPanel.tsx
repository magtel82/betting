  ...
  if (isSidebar) {
    return (
      ...
      >
        ...
        {/* Selections list — fills remaining space, scrolls internally */}
        ...
        {/* Footer — stake + payout + CTA, always visible */}
        <div className="shrink-0 border-t border-gray-100 px-4 pb-4 pt-3 space-y-3">
          {/* Stake row */}
