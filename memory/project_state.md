...
Fas 5A klar (2026-04-22). Nästa = fas 5B (/bet-UI).
...
- **Fas 5A:** Datamodell + serverlogik för matchbetting — bet_slips, bet_slip_selections, match_wallet_transactions, place_bet_slip RPC, placeSlip() + placeSlipAction()

## Nästa steg

- Fas 5B: /bet UI (matchväljare, slip-builder, odds-bekräftelse, submit)
- Fas 5C: /mina-bet (egna slip, status)
