...
-- ============================================================
-- Straffspel — penalty mini-game (migration 20260614000003)
-- ============================================================
-- One best-score row per league member + SECURITY DEFINER leaderboard reader.
-- No coins involved — purely for fun.
...
-- Per-game log — powers "dagens bästa / sämsta" (Stockholm-dygn).
